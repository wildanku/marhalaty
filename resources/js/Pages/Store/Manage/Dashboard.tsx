...
export default function Dashboard() {
  const { store, role, productCount, orderCount } = usePage<DashboardProps>().props;
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {store.status === "approved" && (
                  <Link href={`/stores/${store.slug}`} target="_blank" className="text-xs text-primary hover:underline">
