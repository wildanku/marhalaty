...
export default function EventCreate({ admin }: EventCreateProps) {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    post("/god-mode/events");
  };

  return (
    <GodModeLayout admin={admin} title="Create Event">
      <Head title="God Mode - Create Event" />
            ...
            <div>
              <label className="block text-sm font-medium text-white/70 mb-2">
                ...
                <span className="text-white/40 font-normal">
                  (opsional, dibuat otomatis dari judul)
                </span>
              </label>
              <input
                type="text"
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex-1">
                  ...
                  />
                  <p className="mt-2 text-xs text-white/40">Opsional. Maks 2MB.</p>
                  {fileValidationError && (
