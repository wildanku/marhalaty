          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center gap-16">
            <div className="w-full md:w-3/5 text-left md:pr-12">
              ...
              <p className="text-xl text-on-surface-variant font-body leading-relaxed mb-10 max-w-2xl">
                Portal Alumni Gontor. A quiet lounge where legacy meets future opportunity.
                Reconnect with brothers, support the community, and grow your network.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="/auth/google/redirect"
                  className="flex items-center justify-center gap-3 bg-tertiary text-on-tertiary px-8 py-4 rounded-full font-label font-semibold text-lg hover:bg-tertiary-container hover:text-on-tertiary transition-all shadow-[0px_10px_40px_rgba(119,90,25,0.2)]"
                >
                  <img
                    alt="Google Logo"
                    className="w-6 h-6 bg-white rounded-full p-1"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC778clsHZURkyI2GEselrJF_U6JUWPJV1EHLoo2Q3R23y8mtt4yiMCe8NNlGqETfiFghEgbouV8h1Flj1k4PgN9qRRoxik4yAQj1FUOPnNKPjh0-_iL3rpS53fl6y_HOVomryZ3eYocXteuti9QY__h12a78cyJOx-93pcRXRFoCcvsXrsG9Q0dKgFTKmm-Kr-qvckNq9IRa0m6cCIBOV7SYYCpLH3C8yOjsgicCsoD_47vHgj9QjRZuThXtS1w0a0M57cCU0FczJR"
                  />
            ...
            <div className="w-full md:w-2/5 relative">
              <div className="relative w-full aspect-[4/5] rounded-3xl overflow-hidden shadow-[0px_20px_60px_rgba(80,100,71,0.15)]">
                <img
                  ...
                  className="w-full h-full object-cover"
                  src="https://lh3.googleusercontent.com/aida-public/AB6AXuCWRZHgH5vjwGheQFpqSzGm6R9F2bs7Xr9wWLL-Ol-mA1FgX9l4xh4tXn0dQ3Be8_aTLW-EwExmj4_MgZ_WDuzhW4nPA1ee55F_yuY8B15OvYJw3zSynkM3_vHszGgmFCFTe19l4vE0qpCw6QJxjmmYfBDaJblqLYVI2qUJrHQaOuprYXdrt6-CJ2zGfdSC62Q_MB20n3vnefB-iNa6lrAG9nRXyuy2pXjkxH6egWVngPm_9wrGvNajfR_k8p2ptiY41mbAJkzPtwcx"
                />
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-16">
              ...
              <p className="text-on-surface-variant font-body max-w-2xl">
                Explore opportunities, connect with peers, and contribute to the growth of our
                shared legacy.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-surface-container-lowest rounded-2xl p-8 flex flex-col justify-between group hover:shadow-[0px_10px_40px_rgba(80,100,71,0.08)] transition-all duration-300">
                <div>
                  ...
                  <p className="text-on-surface-variant font-body text-sm mb-6">
                    Find and connect with alumni across different generations and professions
                    worldwide.
                  </p>
                </div>
                <a
              ...
              <div className="bg-surface-container-lowest rounded-2xl p-8 flex flex-col justify-between group hover:shadow-[0px_10px_40px_rgba(80,100,71,0.08)] transition-all duration-300">
                <div>
                  ...
                  <p className="text-on-surface-variant font-body text-sm mb-6">
                    Stay updated on upcoming gatherings, seminars, and community events.
                  </p>
                </div>
                <a
                  href="#"
              ...
              <div className="bg-primary-container rounded-2xl p-8 flex flex-col justify-between relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-on-primary-container/80 font-body text-sm mb-6">
                    Supporting scholarships and community welfare initiatives.
                  </p>
                  <div className="mb-6">
